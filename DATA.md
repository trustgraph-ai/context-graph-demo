...
tg-add-library-document -U trustgraph --name "Consumer Segments" \
    ...
    --identifier "https://trustgraph.ai/retail/consumer-segments" -k text/plain \
...
tg-add-library-document -U trustgraph --name "Brand Profiles" \
    ...
    --identifier "https://trustgraph.ai/retail/brand-profiles" -k text/plain \
...
tg-add-library-document -U trustgraph --name "Retail Channels" \
    ...
    --identifier "https://trustgraph.ai/retail/retail-channels" -k text/plain \
...
tg-add-library-document -U trustgraph --name "AI Agents" \
    ...
    --identifier "https://trustgraph.ai/retail/ai-agents" -k text/plain \
...
tg-add-library-document -U trustgraph --name "Ecosystem Connections" \
    ...
    --identifier "https://trustgraph.ai/retail/ecosystem-connections" -k text/plain \
